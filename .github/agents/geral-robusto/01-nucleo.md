---
description: "Núcleo do pacote do agente. Sempre carregado. Contém princípios inegociáveis, processo de trabalho e mapa para os demais módulos."
applyTo: "**/*"
versao: "3.3"
...
- Consulte a [tabela de carregamento](#9-tabela-de-carregamento-de-m%C3%B3dulos) ao final deste arquivo.
- Catálogo completo dos módulos em [`00-INDICE.md`](./00-INDICE.md).
...
Nem toda tarefa precisa do mesmo processo. Use o modo apropriado (ver [seção 4](#4-modos-de-cerim%C3%B4nia)). Corrigir um typo não exige ADR. Mudar a estrutura de pastas, sim.
...
Conforme o modo de cerimônia (ver [seção 4](#4-modos-de-cerim%C3%B4nia)).
...
- Para Standard, ver [`processos/20-ciclo-tarefa.md`](./processos/20-ciclo-tarefa.md).
- Para Strict, ver [`processos/25-analise-impacto.md`](./processos/25-analise-impacto.md) e [`templates/32-adr.md`](./templates/32-adr.md).
...
Para esse caso, carregue [`processos/27-revisao-geral.md`](./processos/27-revisao-geral.md) e [`templates/37-revisao-geral.md`](./templates/37-revisao-geral.md). A IA pode sugerir uma revisão geral, mas não cria REV por iniciativa própria.
...
Lista curta dos mais perigosos. Lista completa em [`referencias/50-anti-padroes.md`](./referencias/50-anti-padroes.md).
...
|Atualizar teste para "fazer passar"|Esconde bugs reais|Investigar a causa raiz, ver [`padroes/15-testes.md`](./padroes/15-testes.md)|
...
Detalhes completos em [`padroes/10-codigo-e-convencoes.md`](./padroes/10-codigo-e-convencoes.md).
...
Catálogo completo em [`00-INDICE.md`](./00-INDICE.md).
...
|---|---|
|Criar/editar componente React|[`padroes/12-react-e-estado.md`](./padroes/12-react-e-estado.md), [`padroes/13-ui-e-design-system.md`](./padroes/13-ui-e-design-system.md)|
|Criar formulário|[`padroes/14-formularios-e-validacao.md`](./padroes/14-formularios-e-validacao.md)|
|Escrever ou ajustar teste|[`padroes/15-testes.md`](./padroes/15-testes.md)|
|Decidir onde colocar arquivo novo|[`padroes/11-arquitetura-e-pastas.md`](./padroes/11-arquitetura-e-pastas.md)|
|Otimizar performance ou acessibilidade|[`padroes/16-performance-acessibilidade.md`](./padroes/16-performance-acessibilidade.md)|
|Endpoint, service ou lógica de backend|[`padroes/17-backend-node.md`](./padroes/17-backend-node.md)|
|Validar/sanitizar dados sensíveis|[`padroes/18-seguranca-privacidade.md`](./padroes/18-seguranca-privacidade.md)|
|Iniciar tarefa Standard ou Strict|[`processos/20-ciclo-tarefa.md`](./processos/20-ciclo-tarefa.md), [`templates/30-task-em-andamento.md`](./templates/30-task-em-andamento.md)|
|Revisar código|[`processos/21-revisao-codigo.md`](./processos/21-revisao-codigo.md), [`checklists/40-revisao-rapida.md`](./checklists/40-revisao-rapida.md)|
|Humano pedir revisão geral completa do projeto|[`processos/27-revisao-geral.md`](./processos/27-revisao-geral.md), [`templates/37-revisao-geral.md`](./templates/37-revisao-geral.md), [`checklists/40-revisao-rapida.md`](./checklists/40-revisao-rapida.md)|
|Refatorar código existente|[`processos/22-refatoracao.md`](./processos/22-refatoracao.md)|
|Modelar domínio complexo|[`processos/23-modelagem-dominio.md`](./processos/23-modelagem-dominio.md)|
|Traduzir design do Figma para código|[`processos/24-figma-para-codigo.md`](./processos/24-figma-para-codigo.md)|
|Tomar decisão arquitetural relevante|[`processos/25-analise-impacto.md`](./processos/25-analise-impacto.md), [`templates/32-adr.md`](./templates/32-adr.md)|
|Entrar em projeto novo ou legado|[`processos/26-inicializacao-projeto.md`](./processos/26-inicializacao-projeto.md)|
|Criar `contexto-projeto-ai.md`|[`templates/33-contexto-projeto-ai.md`](./templates/33-contexto-projeto-ai.md)|

---

## 10. Comandos Rápidos

Referência completa em [`referencias/51-comandos.md`](./referencias/51-comandos.md).
...
> **Lembrete final:** este arquivo é a fundação. Os demais módulos refinam, exemplificam e detalham - mas nada aqui pode ser ignorado, exceto pelas exceções formais descritas na [seção 1.3](#13-hierarquia-de-regras-resolu%C3%A7%C3%A3o-de-conflito).
