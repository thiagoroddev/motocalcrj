...
# Proibido remover qualquer tarefa dessa lista

> Lista cronológica das tarefas concluídas. Cada linha aponta para o arquivo completo da tarefa.

| TASK-ID | Título | [](Link Clicável do Arquivo) |

|---|---|---|

| TASK-DOM-1 | Atualização da modelagem de domínio | [2026-05-10-TASK-DOM-1.md](./2026-05-10-TASK-DOM-1.md) |
| TASK-DOM-2 | Ajustes referências v6 e registro de DT-14 | [2026-05-11-TASK-DOM-2.md](./2026-05-11-TASK-DOM-2.md) |
| TASK-DOC-3 | (ver arquivo) | [2026-05-12-TASK-DOC-3.md](./2026-05-12-TASK-DOC-3.md) |
| TASK-DOC-4 | (ver arquivo) | [2026-05-12-TASK-DOC-4.md](./2026-05-12-TASK-DOC-4.md) |
| TASK-REF-03 | Instalar shadcn/ui e criar wrappers em components/ui | [2026-05-16--20h21--TASK-REF-03.md](./2026-05-16--20h21--TASK-REF-03.md) |
| TASK-CHORE-004 | Corrigir configuração npm do projeto com `.npmrc` | [2026-05-16--23h18--TASK-CHORE-004.md](./2026-05-16--23h18--TASK-CHORE-004.md) |
| TASK-CHORE-005 | Atualizar Vite, TypeScript e Vitest para versões estáveis recentes | [2026-05-16--23h18--TASK-CHORE-005.md](./2026-05-16--23h18--TASK-CHORE-005.md) |
| TASK-RNF-006 | Migrar Tailwind CSS v3 para v4 e ajustar shadcn/ui | [2026-05-17--01h20--TASK-RNF-006.md](./2026-05-17--01h20--TASK-RNF-006.md) |
| TASK-CHORE-007 | Migrar ESLint v8 para v9 com flat config | [2026-05-17--01h55--TASK-CHORE-007.md](./2026-05-17--01h55--TASK-CHORE-007.md) |
| TASK-RNF-008 | Migrar React 18 → 19 e React Router v6 → v7 | [2026-05-17--19h28--TASK-RNF-008.md](./2026-05-17--19h28--TASK-RNF-008.md) |
| TASK-CHORE-009 | Criar sistema de ícones centralizado | [2026-05-17--20h30--TASK-CHORE-009.md](./2026-05-17--20h30--TASK-CHORE-009.md) |
| TASK-REF-01 | Refatorar PaginaEstimativa.tsx | [2026-05-17--21h30--TASK-REF-01.md](./2026-05-17--21h30--TASK-REF-01.md) |
...
| TASK-REF-18 | Remover `modoExibicao` / toggle "Estimativa sobre dados" / `PaginaRegistros.tsx` (cumpre ADR-003; migração v7→v8) | [2026-05-23--01h05--TASK-REF-18.md](./2026-05-23--01h05--TASK-REF-18.md) |
| TASK-REF-19 | Excluir campos mortos legados do modelo: `modoOficinDisplay`, `precoMaoDeObraIndependente`, `frequenciaRevisaoKm`, `historicoManutencao`, `diarioTrabalho`, 14 actions, 10 funções de `calculos.ts`, `RegistroManutencao` (migração v8→v9) | [2026-05-23--09h02--TASK-REF-19.md](./2026-05-23--09h02--TASK-REF-19.md) |
| TASK-REF-15 | Header de PaginaAjustes: mover página para dentro do LayoutApp (header da moto); promover CabecalhoVoltar a padrão barra superior + usar em PaginaPerfil também | [2026-05-23--09h40--TASK-REF-15.md](./2026-05-23--09h40--TASK-REF-15.md) |
| TASK-BG-004 | RESETAR_AJUSTES_PADRAO agora zera custos (alimentação, seguro, gastosCustom) em vez de presumir gastos; uso e modo de revisão mantidos no padrão (ADR-005) | [2026-05-23--09h48--TASK-BG-004.md](./2026-05-23--09h48--TASK-BG-004.md) |
| TASK-REF-21 | Remove `seguro.tem`: presença de seguro derivada de `valorAnual > 0`; corrige bug B-1 (editar valor em Ajustes não tinha efeito); migração v9→v10 com force-zero; exclui CampoSwitch.tsx morto (ADR-005) | [2026-05-23--10h30--TASK-REF-21.md](./2026-05-23--10h30--TASK-REF-21.md) |
| TASK-RF-6.8 | Cards de revisão Honda exibem peças substituídas e serviços executados | [2026-05-23--11h10--TASK-RF-6.8.md](./2026-05-23--11h10--TASK-RF-6.8.md) |
...
| TASK-RF-6.14 | Adicionar Bateria (driver temporal), Kit Embreagem, Kit Revisão e Kit Cilindro como itens de cálculo; +3 ServicoIndependente; mutual exclusion `kit_cilindro` ↔ `retifica-completa` no reducer; migration v17→v18 | [2026-05-27--00h10--TASK-RF-6.14.md](./2026-05-27--00h10--TASK-RF-6.14.md) |
...
| TASK-BG-009 | Pop-ups colapsavam em larguras ≥640px: `--spacing-sm/md/lg/xl` colidiam com a escala `max-w-*` do Tailwind v4 (`max-w-lg`=24px); fix pontual com valores arbitrários em dialog/sheet/PopoverDetalhesPeca; gera TASK-REF-26 | [2026-05-30--04h30--TASK-BG-009.md](./2026-05-30--04h30--TASK-BG-009.md) |
| TASK-REF-26 | Correção de raiz da BG-009: remove namespace `--spacing-*`, adota escala numérica padrão do Tailwind/shadcn (168 utilities em 44 arquivos, 1:1 px); reverte modais aos canônicos; guard-rail `check-spacing-tokens.mjs` no `npm run lint`; ADR-008 | [2026-05-30--05h08--TASK-REF-26.md](./2026-05-30--05h08--TASK-REF-26.md) |
| TASK-RF-6.18 | Decrementar parcelas restantes de financiamento automaticamente a cada mês (modelagem Snapshot + cálculo Afunilar; migração de schema; Strict + ADR-009) | [2026-05-30--10h19--TASK-RF-6.18.md](./2026-05-30--10h19--TASK-RF-6.18.md) |
| TASK-REF-27 | `calcularCustoFinanciamentoAnual`: 5 parâmetros posicionais → objeto de opções (interface `ParamsCustoFinanciamentoAnual`); refatoração pura, comportamento idêntico, 186 verdes | [2026-05-30--16h19--TASK-REF-27.md](./2026-05-30--16h19--TASK-REF-27.md) |
| TASK-RNF-10 | Validação de runtime (zod) na fronteira de persistência + fallback recuperável (blob inválido → `estadoPadrao` + preserva em `.corrupted`); schema amarrado ao tipo por `expectTypeOf`; Strict + ADR-010; 186→198 verdes | [2026-05-30--17h13--TASK-RNF-10.md](./2026-05-30--17h13--TASK-RNF-10.md) |
| TASK-RNF-11 | ErrorBoundary na raiz (fora dos providers) com escape hatch "Recarregar/Resetar dados"; lógica testável em node (sem render-test); 198→200 verdes | [2026-05-30--18h31--TASK-RNF-11.md](./2026-05-30--18h31--TASK-RNF-11.md) |
...
| TASK-RF-6.31.1 | ADR-020 do fluxo de onboarding: ordem canônica, rotas semânticas, progresso e ramificações | [2026-06-07--21h00--TASK-RF-6.31.1.md](./2026-06-07--21h00--TASK-RF-6.31.1.md) |
...
| TASK-RF-6.37 | Item "Caixa de direção" (serviço extra incompleto) em M.Obra/Insumos/Ajustes: contrato `caixaDirecao` + mapas/horas/ícone + 4 presets; migração `default(0)` não-quebrável | [2026-06-12--20h38--TASK-RF-6.37.md](./2026-06-12--20h38--TASK-RF-6.37.md) |
| TASK-DOM-3 | Dados dos novos modelos Yamaha (fase 1): `servicos-extras-*` (M.O.+vida útil) e `fipe-*` de FZ15/FZ25/Fazer 250/Lander 250 + conferência; gera RF-6.38 e DOM-4 | [2026-06-12--23h01--TASK-DOM-3.md](./2026-06-12--23h01--TASK-DOM-3.md) |
| TASK-RF-6.38 | Freio traseiro a disco (prep): tempário `troca-disco/pastilha-traseira` + ícones de freio (diant+tras) + testes-invariante de `MAPA_PECA_PARA_SERVICO` generalizados p/ todos os presets; `MAPA` em si vai na DOM-4 | [2026-06-13--12h57--TASK-RF-6.38.md](./2026-06-13--12h57--TASK-RF-6.38.md) |
| TASK-DOM-4 | Preset do FZ15 (pioneiro freio traseiro a disco): `fz15.json` completo + entradas do `MAPA_PECA_PARA_SERVICO` (disco/pastilha tras.); CATALOGO auto-deriva; gera DOM-4.2/4.3/4.4 (250s) | [2026-06-13--14h25--TASK-DOM-4.md](./2026-06-13--14h25--TASK-DOM-4.md) |
| TASK-DOM-4.2 | Preset do FZ25 (250cc): `fz25.json` (freio a disco, fator 1.35, consumo 30, intervalos 250); 7 revisões R$ 3.246 | [2026-06-13--15h07--TASK-DOM-4.2.md](./2026-06-13--15h07--TASK-DOM-4.2.md) |
| TASK-DOM-4.3 | Preset do Fazer 250/YS250: `fazerys250.json` (freio a disco, disco diant 790, com filtro de combustível, consumo 35); 7 revisões R$ 3.462 | [2026-06-13--15h14--TASK-DOM-4.3.md](./2026-06-13--15h14--TASK-DOM-4.3.md) |
| TASK-DOM-4.4 | Preset do Lander 250/XTZ250 (trail): `lander250.json` (freio a disco, disco diant 935, pneu com câmara vida 20k/12k, consumo 29); 7 revisões R$ 3.354. Fecha o épico DOM-4 | [2026-06-13--15h21--TASK-DOM-4.4.md](./2026-06-13--15h21--TASK-DOM-4.4.md) |
| TASK-RF-6.39 | "Últimas manutenções" (Ajustes) model-aware (`chavesKmUltimaTrocaDoPreset`) + km-âncora de disco/pastilha diant+tras (4 chaves, migração default(0)); cada modelo mostra só seus freios | [2026-06-13--18h44--TASK-RF-6.39.md](./2026-06-13--18h44--TASK-RF-6.39.md) |
| TASK-BG-033 | Nomes "Kit transmissão"/"Kit caixa de direção" (8 presets+UI) + classificação Completo/Incompleto por `concessionariaIncluiPeca` (avulsos Yamaha viram incompletos e entram no onboarding); `concessionariaInformaPrecoCompleto` | [2026-06-13--18h55--TASK-BG-033.md](./2026-06-13--18h55--TASK-BG-033.md) |
| TASK-DOM-5 | Documentação inicial (fase 1) dos 5 modelos Honda (Start, Fan/Titan, Bros, XRE 190, CB250F): `servicos-extras-*` + `fipe-*` (ao vivo) + conferência; renomes; Honda = preço completo. Gera BG-034/035 | [2026-06-14--16h43--TASK-DOM-5.md](./2026-06-14--16h43--TASK-DOM-5.md) |
| TASK-BG-034 | Insumos oculta a peça de serviço avulso completo (`concessionariaIncluiPeca`): extrai `ehPecaCobertaPorServicoCompleto` (cálculo) e reusa em `PaginaInsumos` (exibição == custo) | [2026-06-14--18h00--TASK-BG-034.md](./2026-06-14--18h00--TASK-BG-034.md) |
| TASK-BG-035 | Onboarding (passo M.O.) mostra subseções Valor Completo/Incompleto via componente compartilhado `SecaoServicosExtras` (extraído de `PaginaMaoDeObra`); total dos incompletos abaixo do toggle | [2026-06-14--19h03--TASK-BG-035.md](./2026-06-14--19h03--TASK-BG-035.md) |
| TASK-BG-036 | Pneu: volta a "Últimas manutenções" (`chavesKmUltimaTrocaDoPreset` lê `preset.pneus`); aba Excepcional→Independente; pneu = só M.O.+peça (fluxo avulso, `SERVICOS_DE_PNEU`), igual Honda/Yamaha diferindo só na aba | [2026-06-14--21h03--TASK-BG-036.md](./2026-06-14--21h03--TASK-BG-036.md) |
| TASK-DOM-6 | Presets Honda fase 2 (6): `cg160start` (piloto, tambor/tambor) + `cg160fan`/`cg160titan` (disco/tambor) + `bros160`/`xre190`/`cb250f` (disco/disco). Incompleto = `concessionariaIncluiPeca:false`; FIPE manual dos docs (update pulado por código duplo Titan/Bros); gera ADR-022, REF-45, RF-8 | [2026-06-14--22h35--TASK-DOM-6.md](./2026-06-14--22h35--TASK-DOM-6.md) |
| TASK-RF-8.1 | Bateria por tempo — motor (parte 1 do épico RF-8): config `perfilManutencao.bateria` (vidaUtilAnos default 3, sem bump) + cálculo (amortiza ÷ anos, M.O. completo/incompleto sem dupla, `proximaTrocaBateria`). Gera RF-8.2 (presets) e RF-8.3 (UI) | [2026-06-15--02h15--TASK-RF-8.1.md](./2026-06-15--02h15--TASK-RF-8.1.md) |
| TASK-RF-8.2 | Bateria nos presets (parte 2 do RF-8): oficial completo nos 6 Honda (Pop/Start/Fan/Titan/Bros/XRE = informado+`concessionariaIncluiPeca:true`); Yamaha+CB250F seguem incompletos por status; bateria sai do card "KM - últimas trocas" (MAPA+LABELS) | [2026-06-15--02h35--TASK-RF-8.2.md](./2026-06-15--02h35--TASK-RF-8.2.md) |
| TASK-RF-8.3 | Bateria — `CardBateria` (parte 3 do RF-8): card próprio em Ajustes + onboarding (`<input month>` da última troca + `Select` de vida útil 2/3/4/5 anos + próxima troca/atraso via `proximaTrocaBateria`). Gera RF-8.4 (Mão de Obra + Detalhamento) | [2026-06-15--02h50--TASK-RF-8.3.md](./2026-06-15--02h50--TASK-RF-8.3.md) |
| TASK-RF-8.4 | Bateria em "Serviços Extras" (parte 4 do RF-8): inclui `troca-bateria` nos avulsos da Mão de Obra (completo Honda/incompleto Yamaha) + `CardServico` troca "Intervalo (km)" por select de vida útil (anos) p/ a bateria; addendum ADR-016 | [2026-06-15--03h08--TASK-RF-8.4.md](./2026-06-15--03h08--TASK-RF-8.4.md) |
| TASK-RF-8.5 | Bateria no Detalhamento + onboarding (parte 5 do RF-8): popup de detalhe mostra vida útil em anos e `1/N` (não "12/1"/"36 meses"); popup de editar mostra o select de anos; bateria aparece no onboarding passo 9 | [2026-06-15--03h32--TASK-RF-8.5.md](./2026-06-15--03h32--TASK-RF-8.5.md) |
| TASK-RF-8.6 | Bateria ancora por data (parte 6 do RF-8): `calcularCicloBateria` (reusa `calcularCicloPeca` em meses) → com data vira `ancorado` (0/1 troca no ano, como km); ícone do calendário visível no tema escuro (CSS); popup mostra a data da última troca | [2026-06-15--06h48--TASK-RF-8.6.md](./2026-06-15--06h48--TASK-RF-8.6.md) |
| TASK-RF-8.7 | **Reverte a ancoragem por data** (RF-8.6): bateria volta a só vida útil em anos (2/3/4/5, default 3), **sempre amortizada**; remove o input de data, os helpers de ciclo/próxima-troca e o threading. Mantém Mão de Obra/presets/popup-em-anos. `ultimaTrocaAnoMes` fica legado inerte | [2026-06-15--07h15--TASK-RF-8.7.md](./2026-06-15--07h15--TASK-RF-8.7.md) |
| TASK-REF-45 | Retífica removida do MVP: presets/defaults, cálculo, reducer e UI; campos legados preservados; Honda sem aba vazia e Yamaha com Independente para pneus | [2026-06-14--23h27--TASK-REF-45.md](./2026-06-14--23h27--TASK-REF-45.md) |
| TASK-RF-9 | Botão de alternar predefinição no header (abaixo do "?"), via `BotaoAlternarPredefinicao` autocontido reusando `IconTrocar`/`DialogAlternarPredefinicao`; desabilitado/desbotado com 1 predefinição | [2026-06-15--07h46--TASK-RF-9.md](./2026-06-15--07h46--TASK-RF-9.md) |
| TASK-REF-46 | Ícone de "Alternar predefinição" unificado: `IconAlternar` (setas "repeat") compartilhado em `components/icons`, reusado no header e no Perfil; remove `IcTrocar` local duplicado de `PaginaPerfil` | [2026-06-15--08h00--TASK-REF-46.md](./2026-06-15--08h00--TASK-REF-46.md) |
| TASK-RF-7.2 | Backup completo (.json): liga Exportar/Importar no Perfil (`backupSchema`/`services/backup`/`utils/arquivo`), action `RESTAURAR_BACKUP` (substituição total) via `reconstruirEstadoDePresets` extraído; baseline zerado na versão 0 (`estimamoto:v0:*`) | [2026-06-15--08h36--TASK-RF-7.2.md](./2026-06-15--08h36--TASK-RF-7.2.md) |
| TASK-RF-8.8 | Bateria embutida no card `SecaoUltimasManutencoes` (CardBateria vira bloco sem `<section>`) + título "KM - últimas trocas/manutenções" → "Registro últimas trocas/manutenções"; aplicado em Ajustes e onboarding | [2026-06-15--09h01--TASK-RF-8.8.md](./2026-06-15--09h01--TASK-RF-8.8.md) |
| TASK-BG-037 | Ancorados sem troca no período (custo 0) deixam de sumir sem rastro: tabela "Próximas trocas fora do período" no popup "?" dos Ancorados (`proximaTrocaKm` exposto no view-model); + guard que capa km da última troca ao `kmAtual` no card de registros | [2026-06-15--10h11--TASK-BG-037.md](./2026-06-15--10h11--TASK-BG-037.md) |
