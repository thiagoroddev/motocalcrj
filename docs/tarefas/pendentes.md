...
> **TASK-DOC-011** concluída em 25/05/26 — ver `docs/tarefas/concluidas/` (sincronização do índice I- com a numeração real do corpo da spec v6.0; 15 linhas em 1 arquivo, modo Light, débito spin-off da DOC-010).

---

> **TASK-DOC-012** concluída em 25/05/26 — ver `docs/tarefas/concluidas/` (métricas de teste em `contexto-projeto-ai.md` substituídas por pointer ao `npm run test`; estratégia pointer > snapshot, 2 linhas em 1 arquivo).
