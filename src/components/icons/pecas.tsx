...
const ICONES: Record<string, IconePeca> = {
  ...
  'troca-disco-dianteiro': IconeSapata,
  'troca-pastilha-dianteira': IconeSapata,
  'troca-disco-traseiro': IconeSapata,
  'troca-pastilha-traseira': IconeSapata,
  ...
  disco_freio_dianteiro: IconeSapata,
  pastilha_freio_dianteiro: IconeSapata,
  disco_freio_traseiro: IconeSapata,
  pastilha_freio_traseiro: IconeSapata,
  ...
  discoFreioDianteiro: IconeSapata,
  pastilhaFreioDianteiro: IconeSapata,
  discoFreioTraseiro: IconeSapata,
  pastilhaFreioTraseiro: IconeSapata,
